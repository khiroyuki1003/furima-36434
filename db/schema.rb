...
ActiveRecord::Schema.define(version: 2021_08_12_105529) do
  ...
  create_table "receiver_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buyer_id"], name: "index_receiver_addresses_on_buyer_id"
  end
  ...
  add_foreign_key "receiver_addresses", "buyers"
end
